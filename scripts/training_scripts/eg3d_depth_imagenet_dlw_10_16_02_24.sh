# previous loss weight was 0.1, seems has no effect on the result, so I will try 10.0
...
CMD="python train.py \
--outdir=${exps_path}/imagenet_128/eg3d_depth_imagenet_dlw_10_16_02_24/ \
--cfg=shapenet \
--gamma=0.3 \
--data=${imagenet_path} \
...
&> ${code_path}/logs/eg3d_depth_imagenet_dlw_10_16_02_24.log"
echo $CMD
